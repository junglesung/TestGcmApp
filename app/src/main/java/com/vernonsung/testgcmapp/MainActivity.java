...
public class MainActivity extends AppCompatActivity {
    ...
    private class HelloServerTask extends AsyncTask<String, Void, Void> {
        ...
        private void sayHello(String message) throws IOException {
            ...
            URL url = new URL(MyConstants.ECHO_URL + "/" + token + "/messages");
    ...
    private void sendUserMessage() {
        ...
        // Prepare data
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(this);
        String registrationToken = sharedPreferences.getString(MyConstants.REGISTRATION_TOKEN, "");
        ...
        UserMessage userMessage = new UserMessage(instanceID, registrationToken, message);
        ...
        // Vernon debug
        Log.d(LOG_TAG, "Send \"" + message + "\" to " + instanceID);
    ...
    private class SendUserMessageTask extends AsyncTask<UserMessage, Void, Void> {
        ...
        private void send(UserMessage userMessage) throws IOException {
            // Prepare URL https://aaa.appspot.com/api/0.1/users/xxxxxx/messages
            // The target user is myself
            URL url = new URL(MyConstants.USER_MESSAGE_URL + "/" + userMessage.getInstanceid() + "/messages");
            HttpsURLConnection urlConnection = (HttpsURLConnection) url.openConnection();
            int size;
            byte[] data;
            OutputStream out;
